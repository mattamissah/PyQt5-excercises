import sys
from PyQt5.QtCore import (QFile,  QTimer, Qt, pyqtSignal)
from PyQt5.QtWidgets import (QApplication, QDialog, QHBoxLayout, QLabel,QMessageBox, QPushButton, QSplitter,
